                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        <?php foreach ($jobs as $job): ?>
                            <div class="card-item flex flex-col">
                                ...
                                ?>
                                <a href="../job_detail_client.php?id=<?= $job['id'] ?>&type=<?= $job['type'] ?>">
                                ...
                                <div class="p-4 md:p-6 flex-grow flex flex-col justify-between">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <a href="../job_detail_client.php?id=<?= $job['id'] ?>&type=<?= $job['type'] ?>" class="mt-2 inline-block btn-primary text-white px-4 py-2 rounded-lg font-medium text-sm shadow-lg w-full text-center">ดูรายละเอียด</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
