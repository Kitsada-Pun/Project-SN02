            ...
            <?php if ($to_user_info): ?>
                <div id="chat-header">
                    ...
                    if (isset($to_user_info['user_type'])) {
                        // เนื่องจากหน้านี้เป็นของ designer, คู่สนทนามักจะเป็น client
                        if ($to_user_info['user_type'] === 'client') {
                            // ***สำคัญ: ตรวจสอบให้แน่ใจว่า path ไปยัง view_profile_client.php ถูกต้อง***
                            $profile_url = 'view_client_profile.php?user_id=' . $to_user_id;


                        } elseif ($to_user_info['user_type'] === 'designer') {
                            $profile_url = 'view_profile.php?user_id=' . $to_user_id;
